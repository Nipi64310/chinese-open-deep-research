...
# chinese open deep research

本项目，主要基于langchain的open deep research项目改造。修改点：
1. 切换模型为中文GLM模型，部分切换为Flash模型，部分为Plus模型，理论上可以任意切换。
2. 修改所有的prompt及描述为中文
3. 修改搜索API为免费的duckduck search
4. 增加函数测试脚本，方便初学者测试每个graph node的效果。 在test_nodes.ipynb下
5. 添加steamlit运行demo

所有协议请遵循原项目 https://github.com/langchain-ai/open_deep_research/tree/main
...
最后再次感谢langchain团队的开源，以及 高校X计划，高校学生、教师可获得资源包+5折模型推理的助力。

![](https://files.mdnice.com/user/50285/f68a4c25-c733-4a25-bf2e-e1da87e11b57.png)

![](https://files.mdnice.com/user/50285/7fa44875-12c5-4b21-8c25-00858a06b0b5.jpg)
